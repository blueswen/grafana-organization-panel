...
Locator: locator('#--r1a---downshift-menu [role="option"] span')
Expected: 10
Received: 0
Call log:
  - expect.toHaveCount with timeout 5000ms
  - waiting for locator('#--r1a---downshift-menu [role="option"] span')
    9 × locator resolved to 0 elements
      - unexpected value "0"

    at /home/runner/work/grafana-organization-panel/grafana-organization-panel/tests/panel.spec.ts:140:27
```
